...
For anything substantial — add a feature, fix a bug across the repo, refactor a
...
Before TMT is allowed to say a piece of work is done, it runs the checks this
repository actually has, and the runtime will not let it answer until they pass.
